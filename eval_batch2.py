...
OFFSET = 0.003
DOWNTOWNS = [
    {"name": "Downtown Seattle (Pioneer Square)", "lat": 47.6015, "lon": -122.3342},
    {"name": "Downtown Toronto (King/Bay)", "lat": 43.6490, "lon": -79.3815},
    {"name": "Downtown Mexico City (Centro)", "lat": 19.4326, "lon": -99.1332},
    {"name": "Downtown Sydney (CBD)", "lat": -33.8688, "lon": 151.2093},
]

def build_downtown(entry):
    lat, lon = entry["lat"], entry["lon"]
    slug = entry["name"].lower().replace(" ", "-").replace("(", "").replace(")", "").replace("/", "-")
